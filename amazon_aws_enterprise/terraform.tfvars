...
subnet_id = "subnet-0123456789abcdef0"       # Your AWS subnet ID: Must change (make sure the subnet is within the availability zone)

vpc_id = "vpc-0123456789abcdef0"    # Your AWS vpc ID: Must change (make sure this is the vpc that hosts subnet)

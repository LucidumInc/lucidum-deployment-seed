...
playbook_version = "v0.3.7"                # Lucidum Product Version: change when new version is released
...
subnet_id = "subnet-0123456789abcdef0"       # Your AWS subnet ID: change as needed (make sure the subnet is within the availability zone)

vpc_id = "vpc-0123456789abcdef0"    # Your AWS vpc ID: change as needed (make sure this is the vpc that hosts subnet)
